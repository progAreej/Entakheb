...
function LoginForm({ nationalID, setNationalID, name, setName, handleLogin }) {
  ...
  return (
    <div className="text-right ">
      <h2 className="text-2xl font-bold mb-4 text-center text-zait">
        انشاء حساب
      </h2>
      <input
        type="text"
        ...
        value={nationalID}
        onChange={(e) => setNationalID(e.target.value)}
        className={`w-full px-4 py-2 mb-4 text-right border rounded-lg focus:outline-none focus:ring-2  focus:ring-zait  ${
          errors.nationalID ? "border-red-500" : "border-gray-300"
        }`}
      />
      {errors.nationalID && (
      ...
      <p className="mt-4 text-center text-gray-600">
        عندك حساب؟{" "}
        <Link to="/login" className="text-zait hover:underline">
          {" "}
          تسجيل الدخول
        </Link>
      </p>
